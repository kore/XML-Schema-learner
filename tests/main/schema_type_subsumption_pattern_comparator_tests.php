 ...
 * Test class
 */
class slMainSchemaTypeSubsumingPatternComparatorTests extends slMainSchemaTypeEqualPatternComparatorTests
{
    /**
    ...
    protected $results = array(
        ...
        'testTypePatternSubsumption'          => true,
    );
    ...
    {
        return new slSchemaTypeSubsumingPatternComparator();
    }
}
