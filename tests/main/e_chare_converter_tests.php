 ...
 * Test class
 */
class slMainEChareConverterTests extends PHPUnit_Framework_TestCase
{
    /**
     * Return test suite
     *
    ...
    public function testConvertOrderInsignificant2()
    {
        $automaton = new slCountingSingleOccurenceAutomaton();
    ...
    public function testConvertOrderInsignificant3()
    {
        $automaton = new slCountingSingleOccurenceAutomaton();
        $automaton->learn( array( 'a', 'b', 'c' ) );
        $automaton->learn( array( 'b', 'c', 'a' ) );
        $automaton->learn( array( 'c', 'b' ) );
    ...
    public function testConvertOrderInsignificantWithFollowUp()
    {
        $automaton = new slCountingSingleOccurenceAutomaton();
        $automaton->learn( array( 'a', 'b', 'c' ) );
