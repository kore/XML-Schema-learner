 ...
 * Test class
 */
class slMainSchemaTypeSameAttributeComparatorTests extends slMainSchemaTypeStrictAttributeComparatorTests
{
    /**
    ...
    {
        return new slSchemaTypeSameAttributeComparator();
    }
}
